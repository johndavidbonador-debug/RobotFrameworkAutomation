*** Settings ***
Documentation    This is to create test cases to CSV file
Library    SeleniumLibrary  #downloaded under settings > interpreter
Library    DataDriver   file=resources/data.csv     encoding=utf_8      dialect=unix       #downloaded under settings > interpreter
...
*** Test Cases ***
Login with user ${username} and password ${password}    #this is generic terms for calling the test cases from csv. this will also be used as the name of the test name leave blank
